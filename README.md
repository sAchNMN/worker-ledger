...
- 应用内隐私政策：顶栏可直接查看完整隐私政策，页面离线内置，查看时不需要联网。
...
应用不申请任何权限，不收集、不上传、不共享任何个人信息。完整说明见 [隐私政策](https://sachnmn.github.io/worker-ledger/privacy.html)，仓库内亦有 [Markdown 版本](PRIVACY.md)。
